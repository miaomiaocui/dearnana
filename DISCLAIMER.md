...
- **Ranking is done server-side, with no AI.** When you search, your address, budget, and care-needs selections are sent to the DearNana serverless function to geocode, fetch CMS data, and rank facilities. This data is processed **transiently for that one request and is not stored, logged, or sold.** No AI is involved in this step.
