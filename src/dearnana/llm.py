...
def get_provider() -> LLMProvider | None:
    ...
    switch providers without re-importing. (The model names, however, are
    resolved from the environment once at import — set DEARNANA_LLM_MODEL /
    DEARNANA_PARSER_MODEL before importing dearnana.)
    """
