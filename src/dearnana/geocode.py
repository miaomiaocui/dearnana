...
try:
    _VERSION = _pkg_version("dearnana")
except PackageNotFoundError:
    _VERSION = "0.0.0"

# Nominatim's usage policy asks for an identifying app + contact in the UA.
_USER_AGENT = f"dearnana/{_VERSION} (+https://github.com/miaomiaocui/dearnana)"
