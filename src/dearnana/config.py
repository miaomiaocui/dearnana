...
# Provider: "anthropic" (default, requires ANTHROPIC_API_KEY) or "ollama"
# (local models, nothing leaves your machine).
LLM_PROVIDER = os.environ.get("DEARNANA_LLM_PROVIDER", "anthropic")
...
OLLAMA_HOST = os.environ.get("DEARNANA_OLLAMA_HOST", "http://localhost:11434")
